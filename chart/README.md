...
| alert.enabled | bool | `true` | If false, skip creating the alerting rules PrometheusRule |
...
| dashboard.enabled | bool | `true` | If false, skip creating Grafana dashboard ConfigMaps |
...
| rule.enabled | bool | `true` | If false, skip creating the recording rules PrometheusRule |
